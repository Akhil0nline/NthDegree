...
test('Verify that Charge for Order defaults to "Yes" when Line of Business is "Fern: City Project" AND Verify that Price List Overridden is set to "No" when Price List matches the Show Price List', async ({ page }) => {
