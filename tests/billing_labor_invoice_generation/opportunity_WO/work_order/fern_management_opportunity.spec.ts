...
test('Verify that Charge for Order defaults to "Yes" when Line of Business is "Fern: Management Order"', async ({ page }) => {
    ...
    await page.getByRole('option', { name: 'Fern: Management Order' }).click();
    ...
    expect(opportunityNumber).toContain("OM");
