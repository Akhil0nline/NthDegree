...
test('Verify that Charge for Order defaults to "No" when Line of Business is "Fern: Show Organizer General"', async ({ page }) => {
    ...
    await page.getByRole('option', { name: 'Fern: Show Organizer General' }).click();
    ...
    expect(opportunityNumber).toContain("OP");
